...
filiejson = {
    ...
    'keys': [b'\xd6\xcc\xecn_\x8a9\x9dF\xef\x8a\xf6\x8d\x02\xc1\xa1',
             ...
             b"\xec\xa0\x81w\xa6\xc8\xa0\x12\x88\xbb\x17~Dj'I"],
    'nonces': [b'\x04\x03\xa3o\xf1\xa6\xa2\xf2\xab\x8b#',
...
ciphertext = filiejson['ciphertext']
tag = filiejson['tag']
keys = filiejson['keys']
nonces = filiejson['nonces']
...
for key in keys:
    for nonce in nonces:
        ...
        if decrypted:
            ...
            print("Message wyszlo: ", decrypted)
            break
print("Message powinno byc: ", message)
